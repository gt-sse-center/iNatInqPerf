...
def test_embed_with_overrides(monkeypatch, tmp_path):
    ...
    def _embed_images(raw_dir, model_id, batch_size):
        embed_calls.append((raw_dir, model_id, batch_size))
        return ImageDatasetWithEmbeddings(np.ones((2, 3), dtype="float32"), [10, 11], [0, 1])
